# FinalBurn Neo, streaming server
...
alldir += burner burner/pi burner/sdl dep/libs/libpng dep/libs/lib7z \
		dep/libs/zlib intf intf/video intf/video/scalers intf/video/ss \
...
DEF	:= -DBUILD_SDL -DBUILD_PI -DUSE_SPEEDHACKS -DFILENAME=$(NAME) -DNO_SDL_VIDEO
